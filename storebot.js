import { api, esc, getForwardInfo } from "./telegram.js";
...
async function cmdAddForcesub(msg, tg, botData) {
  await kv.setState(botData.bot_id, msg.from.id, { flow: "add_forcesub" });
  return tg.send(msg.chat.id, "Force-Sub Channel/Group se koi bhi message forward karein:\n\n━━━━━━━━━━━━━━\nForward any message from your Force-Sub Channel/Group:");
}
...
export async function handleCloneBot(update, botId, origin) {
  ...
  if (msg.text && msg.text.startsWith("/")) {
    ...
    if (cmd === "addforcesub") return cmdAddForcesub(msg, tg, botData);
