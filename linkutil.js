import { LINK_SECRET_KEY } from "./config.js";
...
function requireSecret() {
  if (!LINK_SECRET_KEY || LINK_SECRET_KEY.length < 16) {
    throw new Error("LINK_SECRET_KEY is not set (or too short) — set a long random value in Deno Deploy env vars before generating links.");
  }
  return new TextEncoder().encode(LINK_SECRET_KEY);
}
